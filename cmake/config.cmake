...
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Xenon")
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/scripts/xenon-utils.cmake")
    include("${CMAKE_CURRENT_LIST_DIR}/toolchain/xenon-toolchain.cmake")
endif()
...
set(BINARY_OUTPUT_DIR bin/${PLATFORM_NAME}${ARCH_PREFIX})
set(LIBRARY_OUTPUT_DIR lib/${PLATFORM_NAME}${ARCH_PREFIX})
